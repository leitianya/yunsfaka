<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:79:"/www/wwwroot/demo.xiangfa.me/public/../application/admin/view/config/gtips.html";i:1503634141;s:77:"/www/wwwroot/demo.xiangfa.me/public/../application/admin/view/conmm/main.html";i:1503634141;s:77:"/www/wwwroot/demo.xiangfa.me/public/../application/admin/view/conmm/head.html";i:1503634141;s:77:"/www/wwwroot/demo.xiangfa.me/public/../application/admin/view/conmm/foot.html";i:1503634141;}*/ ?>
    ...
    <div class="tpl-portlet-components">
        <div class="portlet-title">
            <div class="caption font-green bold">
                <span class="am-icon-code"></span> 公告设置
            </div>
        ...
        <div class="tpl-block ">
            ...
            <div class="am-g tpl-amazeui-form">
                ...
                <div class="am-u-sm-12 am-u-md-9">
                    <form class="am-form am-form-horizontal" method="post" action="<?php echo url('admin/Config/gtips'); ?>">
                        <div class="am-form-group">
                            <label for="altps" class="am-u-sm-3 am-form-label">首页弹出公告</label>
                            <div class="am-u-sm-9">
                                <textarea name="altps" class="" rows="10" id="altps" placeholder="首页弹出公告文字"><?php echo $info['altps']; ?></textarea>

                            </div>
                        </div>
                        <div class="am-form-group">
                            <label for="gtips" class="am-u-sm-3 am-form-label">公告</label>
                            <div class="am-u-sm-9">
                                <textarea name="gtips" class="" rows="10" id="gtips" placeholder="首页的公告设置"><?php echo $info['gtips']; ?></textarea>

                            </div>
                        </div>

                        <div class="am-form-group">
                            <label for="foot" class="am-u-sm-3 am-form-label">友情链接</label>
                            <div class="am-u-sm-9">
                                <textarea name="foot" class="" rows="10" id="foot" placeholder="友情链接、备案信息等"><?php echo $info['foot']; ?></textarea>
