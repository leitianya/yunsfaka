<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:78:"/www/wwwroot/demo.xiangfa.me/public/../application/admin/view/goods/impka.html";i:1503634141;s:77:"/www/wwwroot/demo.xiangfa.me/public/../application/admin/view/conmm/main.html";i:1503634141;s:77:"/www/wwwroot/demo.xiangfa.me/public/../application/admin/view/conmm/head.html";i:1503634141;s:77:"/www/wwwroot/demo.xiangfa.me/public/../application/admin/view/conmm/foot.html";i:1503634141;}*/ ?>
...
<div class="tpl-content-wrapper">
    ...
    <ol class="am-breadcrumb">
        <li><a href="" class="am-icon-cogs">导入卡密</a></li>
    ...
    <div class="tpl-portlet-components">
        <div class="portlet-title">
            <div class="caption font-green bold">
                <span class="am-icon-code"></span> 导入卡密
            </div>
        ...
        <div class="tpl-block ">
            ...
            <div class="am-g tpl-amazeui-form">
                ...
                <div class="am-u-sm-12 am-u-md-9">
                    <form class="am-form am-form-horizontal" method="post" action="<?php echo url('admin/Goods/impka'); ?>">
                        <div class="am-form-group">
                            <label for="kami" class="am-u-sm-3 am-form-label">卡密列表</label>
                            <div class="am-u-sm-9">
                                <textarea name="kami" class="" rows="30" id="kami" placeholder="请输入卡号列表，一行一个。如有卡密请按照格式  卡号----卡密 填写，一行一个" required></textarea>
