<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:78:"/www/wwwroot/demo.xiangfa.me/public/../application/admin/view/config/stmp.html";i:1503634141;s:77:"/www/wwwroot/demo.xiangfa.me/public/../application/admin/view/conmm/main.html";i:1503634141;s:77:"/www/wwwroot/demo.xiangfa.me/public/../application/admin/view/conmm/head.html";i:1503634141;s:77:"/www/wwwroot/demo.xiangfa.me/public/../application/admin/view/conmm/foot.html";i:1503634141;}*/ ?>
    ...
    <div class="tpl-portlet-components">
        <div class="portlet-title">
            <div class="caption font-green bold">
                <span class="am-icon-code"></span> 邮件设置
            </div>
        ...
        <div class="tpl-block ">
            ...
            <div class="am-g tpl-amazeui-form">
                ...
                <div class="am-u-sm-12 am-u-md-9">
                    <form class="am-form am-form-horizontal" method="post" action="<?php echo url('admin/Config/stmp'); ?>">
                        <div class="am-form-group">
                            <label for="server" class="am-u-sm-3 am-form-label">SMTP服务器</label>
                            <div class="am-u-sm-9">
                                <input type="text" value="<?php echo $info['server']; ?>" name="server" id="server" placeholder="SMTP服务器 如stmp.qq.com">

                            </div>
                        </div>

                        <div class="am-form-group">
                            <label for="port" class="am-u-sm-3 am-form-label">SMTP服务器端口</label>
                            <div class="am-u-sm-9">
                                <input type="text"  value="<?php echo $info['port']; ?>" name="port" id="port" placeholder="SMTP服务器端口">

                            </div>
                        </div>

                        <div class="am-form-group">
                            <label for="user" class="am-u-sm-3 am-form-label">STMP账号</label>
                            <div class="am-u-sm-9">
                                <input type="text" value="<?php echo $info['user']; ?>" name="user" id="user" placeholder="如53331323@qq.com">
                            </div>
                        </div>

                        <div class="am-form-group">
                            <label for="passwd" class="am-u-sm-3 am-form-label">SMTP密码</label>
                            <div class="am-u-sm-9">
                                <input type="password" value="<?php echo $info['passwd']; ?>" name="passwd"  id="passwd" placeholder="SMTP密码">
                            </div>
                        </div>
