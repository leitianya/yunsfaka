<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:77:"/www/wwwroot/demo.xiangfa.me/public/../application/admin/view/goods/edit.html";i:1503634141;s:77:"/www/wwwroot/demo.xiangfa.me/public/../application/admin/view/conmm/main.html";i:1503634141;s:77:"/www/wwwroot/demo.xiangfa.me/public/../application/admin/view/conmm/head.html";i:1503634141;s:77:"/www/wwwroot/demo.xiangfa.me/public/../application/admin/view/conmm/foot.html";i:1503634141;}*/ ?>
...
<div class="tpl-content-wrapper">
    ...
    <ol class="am-breadcrumb">
        <li><a href="" class="am-icon-cogs">编辑商品</a></li>
    ...
    <div class="tpl-portlet-components">
        <div class="portlet-title">
            <div class="caption font-green bold">
                <span class="am-icon-code"></span> 编辑商品
            </div>
        ...
        <div class="tpl-block ">
            ...
            <div class="am-g tpl-amazeui-form">
                ...
                <div class="am-u-sm-12 am-u-md-9">
                    <form class="am-form am-form-horizontal" method="post" action="<?php echo url('admin/Goods/edit'); ?>">
                        <div class="am-form-group">
                            <label for="name" class="am-u-sm-3 am-form-label">商品名称</label>
                            <div class="am-u-sm-9">
                                <input type="text" value="<?php echo $info['name']; ?>" name="name" id="name" placeholder="商品名称" required>
                        ...
                        <div class="am-form-group">
                            <label for="cid" class="am-u-sm-3 am-form-label">商品分类</label>
                            <div class="am-u-sm-9">
                                <select name="cid" id="cid">
                                    <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$v): ?>
                                    <option <?php if($info['cid'] == $v['id']): ?>selected<?php endif; ?> value="<?php echo $v['id']; ?>"><?php echo $v['name']; ?></option>
                        ...
                        <div class="am-form-group">
                            <label for="money" class="am-u-sm-3 am-form-label">商品单价</label>
                            <div class="am-u-sm-9">
                                <input type="text" value="<?php echo $info['money']; ?>" name="money" id="money" placeholder="输商品价格" required>
                            </div>
                        </div>

                        <div class="am-form-group">
                            <label for="otitle" class="am-u-sm-3 am-form-label">第一个输入框标题</label>
                            <div class="am-u-sm-9">
                                <input type="text" value="<?php echo $info['otitle']; ?>" name="otitle"  id="otitle" placeholder="如 QQ号">
                            </div>
                        </div>

                        <div class="am-form-group">
                            <label for="tcheck" class="am-u-sm-3 am-form-label">是否需要第二个输入框</label>
                            <div class="am-u-sm-9">
                                否<input type="radio" value="0" name="tcheck" <?php if($info['tcheck'] == '0'): ?>checked<?php endif; ?> >
                                是<input type="radio" value="1" name="tcheck" <?php if($info['tcheck'] == '1'): ?>checked<?php endif; ?> >
                            </div>
                        </div>
                        <div class="am-form-group">
                            <label for="ttitle" class="am-u-sm-3 am-form-label">第二个输入框标题</label>
                            <div class="am-u-sm-9">
                                <input type="text" value="<?php echo $info['ttitle']; ?>" name="ttitle" id="ttitle" placeholder="第二个输入框标题，如密码">
                            </div>
                        </div>

                        <div class="am-form-group">
                            <label for="scheck" class="am-u-sm-3 am-form-label">是否需要第三个输入框</label>
                            <div class="am-u-sm-9">
                                否<input type="radio" value="0" name="scheck" <?php if($info['scheck'] == '0'): ?>checked<?php endif; ?> >
                                是<input type="radio" value="1" name="scheck" <?php if($info['scheck'] == '1'): ?>checked<?php endif; ?> >
                            </div>
                        </div>

                        <div class="am-form-group">
                            <label for="stitle" class="am-u-sm-3 am-form-label">第三个输入框标题</label>
                            <div class="am-u-sm-9">
                                <input type="text" value="<?php echo $info['stitle']; ?>" name="stitle" id="stitle" placeholder="如 确认密码">
                            </div>
                        </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                上架<input type="radio" value="1" name="status" <?php if($info['status'] == '1'): ?>checked<?php endif; ?> >
                                下架<input type="radio" value="2" name="status" <?php if($info['status'] == '2'): ?>checked<?php endif; ?> >
                            </div>
                        </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <input type="text" value="<?php echo $info['ord']; ?>" name="ord" id="ord" placeholder="整数  输入值越大 排名越靠前">
                            </div>
                        </div>
                        ...
                        <div class="am-form-group">
                            <div class="am-u-sm-9 am-u-sm-push-3">
                                ...
                                <a href="javascript:history.go(-1);" class="am-btn am-btn-warning">返回</a>
                            </div>
                        </div>
                    </form>
                </div>
