<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:79:"/www/wwwroot/demo.xiangfa.me/public/../application/admin/view/goods/create.html";i:1503634141;s:77:"/www/wwwroot/demo.xiangfa.me/public/../application/admin/view/conmm/main.html";i:1503634141;s:77:"/www/wwwroot/demo.xiangfa.me/public/../application/admin/view/conmm/head.html";i:1503634141;s:77:"/www/wwwroot/demo.xiangfa.me/public/../application/admin/view/conmm/foot.html";i:1503634141;}*/ ?>
...
<div class="tpl-content-wrapper">
    ...
    <ol class="am-breadcrumb">
        <li><a href="" class="am-icon-cogs">添加商品</a></li>
        ...
        <div class="tpl-block ">
            ...
            <div class="am-g tpl-amazeui-form">
                ...
                <div class="am-u-sm-12 am-u-md-9">
                    <form class="am-form am-form-horizontal" method="post" action="<?php echo url('admin/Goods/create'); ?>">
                        <div class="am-form-group">
                            <label for="name" class="am-u-sm-3 am-form-label">商品名称</label>
                            <div class="am-u-sm-9">
                                <input type="text" value="" name="name" id="name" placeholder="商品名称" required>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <input type="text" value="0" name="money" id="money" placeholder="输商品价格" required>
                            </div>
                        </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <input type="text" value="QQ账号" name="otitle"  id="otitle" placeholder="如 QQ号">
                            </div>
                        </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                否<input type="radio" value="0" name="tcheck" checked >
                                是<input type="radio" value="1" name="tcheck" >
                            </div>
                        </div>
                        <div class="am-form-group">
                            <label for="ttitle" class="am-u-sm-3 am-form-label">第二个输入框标题</label>
                            <div class="am-u-sm-9">
                                <input type="text" value="" name="ttitle" id="ttitle" placeholder="第二个输入框标题，如密码">
                            </div>
                        </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                否<input type="radio" value="0" name="scheck" checked >
                                是<input type="radio" value="1" name="scheck" >
                            </div>
                        </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <input type="text" value="" name="stitle" id="stitle" placeholder="如 确认密码">
                            </div>
                        </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                上架<input type="radio" value="1" name="status" checked >
                                下架<input type="radio" value="2" name="status" >
                            </div>
                        </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <input type="text" value="0" name="ord" id="ord" placeholder="整数  输入值越大 排名越靠前">
                            </div>
                        </div>
