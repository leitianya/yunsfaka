<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:78:"/www/wwwroot/demo.xiangfa.me/public/../application/admin/view/goods/index.html";i:1503634141;s:77:"/www/wwwroot/demo.xiangfa.me/public/../application/admin/view/conmm/main.html";i:1503634141;s:77:"/www/wwwroot/demo.xiangfa.me/public/../application/admin/view/conmm/head.html";i:1503634141;s:77:"/www/wwwroot/demo.xiangfa.me/public/../application/admin/view/conmm/foot.html";i:1503634141;}*/ ?>
                ...
                <div class="am-u-sm-12 am-u-md-6">
                    <div class="am-btn-toolbar">
                        <div class="am-btn-group am-btn-group-xs">
                            <button onclick="shangxAll('<?php echo url('admin/Goods/update'); ?>',2)" type="button" class="am-btn am-btn-default am-btn-secondary"><span class="am-icon-pencil"></span> 下架</button>
                            <button onclick="shangxAll('<?php echo url('admin/Goods/update'); ?>',1)" type="button" class="am-btn am-btn-default am-btn-success"><span class="am-icon-check"></span> 上架</button>
                            <button onclick="delAll('<?php echo url('admin/Goods/delete'); ?>')" type="button" class="am-btn am-btn-default am-btn-danger"><span class="am-icon-close"></span> 删除</button>
                            <a href="<?php echo url('admin/Goods/create',['type' => 1]); ?>" class="am-btn am-btn-default am-btn-warning"><span class="am-icon-hand-grab-o"></span> 新增手工商品</a>
                            <a href="<?php echo url('admin/Goods/create',['type' => 2]); ?>" class="am-btn am-btn-default am-btn-info"><span class="am-icon-credit-card"></span> 新增卡密商品</a>
                        </div>
                    </div>
                </div>
                <form method="get" action="<?php echo url('admin/Goods/index'); ?>">
                    ...
                    <div class="am-u-sm-12 am-u-md-3">
                        <div class="am-input-group am-input-group-sm">
                            <input type="text" name="account" value="<?php echo $name; ?>" placeholder="商品名称" class="am-form-field">
                    ...
                    <table class="am-table am-table-striped am-table-hover table-main">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="am-btn-toolbar">
                                    <div class="am-btn-group am-btn-group-xs">
                                        <a href="<?php echo url('admin/Goods/edit',['id'=>$v['id'],'type' => $v['type']]); ?>" class="am-btn am-btn-default "><span class="am-icon-pencil"></span>编辑</a>
                                        <?php if($v['type'] ==  2): ?>
                                        <a href="<?php echo url('admin/Goods/impka',['id'=>$v['id']]); ?>" class="am-btn am-btn-default "><span class="am-icon-mail-forward">导入卡密</span></a>
                                        <a href="<?php echo url('admin/Goods/kamilist',['id'=>$v['id']]); ?>" class="am-btn am-btn-default "><span class="am-icon-eye">查看卡密</span></a>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </td>
